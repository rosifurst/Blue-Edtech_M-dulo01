...
while cont == 0:
  ...
  number = 1
  counter = 1
  qtd = int(input('Número de elementos: '))
  lista = []
  ...
  for i in lista:
    reversed = sorted(lista, reverse= True)
  print(f'Lista reversa: {reversed}',end=' ')

  print()
  print()
  resp = input('Deseja continuar?[sim/nao]: ').lower()
  print()
